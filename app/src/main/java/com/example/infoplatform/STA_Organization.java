...
public class STA_Organization extends AppCompatActivity {
    //显示的图表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entries.add(new BarEntry(41f, 2));
        entries.add(new BarEntry(47f, 3));
        entries.add(new BarEntry(55f, 4));
        ...
        dataset = new BarDataSet(entries, "防治组织统计数据（个）");
